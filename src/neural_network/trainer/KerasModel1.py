...
class Kerasmodel:
    ...
    """
    def __init__(self, train_set_provider, opt, loss='binary_crossentropy', metrics=k.metrics.binary_accuracy,
    ...
    def train(self, iterations, epochs_per_iteration, train_batch_size=20, class_weight=None, validation=None,
              sleep_time=None, rest_every=None, train_set_chunk_size=10000, reader_workers=8, letter=0):
        """
        ...
        for i in range(iterations):
            ...
            self.mod.fit(x=x/255, y=y[:,letter], batch_size=train_batch_size, epochs=epochs_per_iteration, verbose=1,
